...
// Query
    $pet = query("SELECT p.id id, k.nama kategori, p.nama nama, umur, vaksin, deskripsi, img FROM pet p
                        JOIN kategori k ON (p.kategori_ID=k.id)");
    //tombol cari
    if ( isset($_POST["cari"])){
        $pet = caripet($_POST["keyword"]);
    }
?>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.0/jquery.min.js" integrity="sha256-xNzN2a4ltkB44Mc/Jz3pT4iU1cmeR0FkXs4pru/JxaQ=" crossorigin="anonymous"></script>
    ...
    <title>Pets | Admin Control</title>
                        ...
                        <div class="col-xl-12 col-lg-10">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-warning">Daftar Pets</h6>
                                </div>
                                <div class="d-flex justify-content-center p-2 pb-2 overflow-y-scroll" style="max-height: 20rem;">
                                    ...
                                    <tr>
                                        ...
                                        <td><?= ($row["kategori"])?></td>                            
                                        <td>
                                        <img class="img" src="../../img/pets<?php echo $row['img'];?>" alt="Responsive image">
                                    </td>
                                        <td><?= ($row["nama"])?></td>
                                        <td><?= ($row["umur"])?></td>
                                        <td><?= ($row["vaksin"])?></td>
                                        ...
                                        <td class="">
                                            ...
                                            <a href="plus.php?id=<?= $row["id"];?>"><button type="button" class="btn btn-secondary btn-sm p-1"><i class="bi bi-clipboard2-plus p-1"></i></button></a>
                                        </td>
                                    </tr>
                                    <?php endforeach ?>
                                    </table>
