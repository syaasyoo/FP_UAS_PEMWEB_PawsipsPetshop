...
$id = $_GET["id"];
$ganti  = query("SELECT p.id id, p.kategori_ID kid, k.nama kategori, p.nama nama, vaksin, deskripsi, umur, img FROM pet p
                  JOIN kategori k ON (p.kategori_ID=k.id) WHERE p.id = $id")[0];

if ( isset($_POST["submit"])){
  if (tambahpet($_POST) > 0){
    echo "
      <script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.0/jquery.min.js" integrity="sha256-xNzN2a4ltkB44Mc/Jz3pT4iU1cmeR0FkXs4pru/JxaQ=" crossorigin="anonymous"></script>
    ...
    <title>Tambah Pets | Admin Control</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCharts1" class="collapse" aria-labelledby="headingCharts"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="..\pet\pet.php">Pets</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Begin Page Content -->
                ...
                <div class="d-flex justify-content-start pb-3">
                  <a href="pet.php"><button type="button" class="btn btn-light"><i class="bi bi-back"></i> Kembali</button></a>
                </div>
                <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ubah Pets</h1>
                    </div>
                <!-- Content Row -->
                    <!-- Formulir -->
                        ...
                        <div class="row">
                          <div class="col">
                            <div class="mb-2">
                              ...
                              <input class="form-control" type="text" name="umur" id="umur" required autocomplete ="off" value = "<?= ($ganti["umur"])?>">  
                            </div>
                            <div class="mb-2">
                              <label for="vaksin" class="form-label">Vaksin</label>
                                                        <select class="form-select"  name="vaksin" id="vaksin" required >
                              <option selected > <?= ($ganti["vaksin"])?></option>
    	...
    	<option value="3">3</option>
                          ...
                          <div class="col">
                            <div class="mb-2">
                              ...
                              <textarea class="form-control" name="deskripsi" id="deskripsi" value = "<?= ($ganti["deskripsi"])?>" style="height: 117px"><?= ($ganti["deskripsi"])?></textarea>
                            </div>
                          </div>
                        </div>
                                                          <div id="p-img" class="form-group">
                    <label for="petstimage"> Masukkan Image</label>
                    <input type="file" name="img" id="img" class="form-control-file" required>
                </div>
                        
                        
                        <div class="d-flex justify-content-center mb-3">
                          <button type="submit" name="submit" class="btn btn-warning">Tambahkan</button>
                        </div>
                      </form>
                    <!-- Akhir Formulir -->
                <!-- /.container-fluid -->
