    ...
    <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Begin Page Content -->
                ...
                <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Pets</h1>
                    </div>
                <!-- Content Row -->
                    <!-- Formulir -->
                        ...
                        <div class="row">
                          <div class="col">
                            <div class="mb-2">
                              ...
                              <input class="form-control" type="text" name="umur" id="umur" required autocomplete ="off">  
                            </div>
                            <div class="mb-2">
    	...
    	<option value="3">3</option>
                          ...
                          <div class="col">
                            <div class="mb-2">
                              ...
                              <textarea class="form-control" name="deskripsi" id="deskripsi" style="height: 117px"></textarea>
                            </div>
                          </div>
                        </div>
