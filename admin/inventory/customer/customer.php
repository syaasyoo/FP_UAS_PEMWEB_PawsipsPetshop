...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.0/jquery.min.js" integrity="sha256-xNzN2a4ltkB44Mc/Jz3pT4iU1cmeR0FkXs4pru/JxaQ=" crossorigin="anonymous"></script>
    ...
    <title>Customer | DB-Inventory Control</title>
                ...
                <!-- Content Row -->
                    ...
                    <!-- Pencarian -->
                        ...
                        <div class="col-md-auto ps-3">
                            <a href="tambah.php"><button type="button" class="btn btn-primary me-4">Tambah Customer <i class="bi bi-plus-lg"></i></button></a>
                        </div>
                    </div>
                <!-- Content Row -->
                    <div class="row">
