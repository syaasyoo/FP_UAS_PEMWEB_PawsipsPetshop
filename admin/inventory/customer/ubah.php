...
$id = $_GET["id"];
$ganti  = query("SELECT * FROM customer WHERE id = $id")[0];
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.0/jquery.min.js" integrity="sha256-xNzN2a4ltkB44Mc/Jz3pT4iU1cmeR0FkXs4pru/JxaQ=" crossorigin="anonymous"></script>
    ...
    <title>Edit Customer | DB-Inventory Control</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Begin Page Content -->
                ...
                <div class="d-flex justify-content-start pb-3">
                  <a href="customer.php"><button type="button" class="btn btn-light"><i class="bi bi-back"></i> Kembali</button></a>
                </div>
                <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <!-- Formulir -->
                      <form action="" method ="post" enctype="multipart/form-data" class="row g-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col mb-2">
                                <label for="notelp" class="form-label">Nomor HP/Telepon</label>
                                <input class="form-control" type="text" placeholder="e.g : +6281000000" name="notelp" id="notelp" required autocomplete ="off" value = "<?= ($ganti["notelp"])?>">  
                            </div>
                        </div>
                        <div class="mb-2">
                          <label for="alamat">Alamat</label>
                          <textarea class="form-control" name="alamat" id="alamat" style="height: 7rem"><?= ($ganti["alamat"])?></textarea>
                        </div>
