...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.0/jquery.min.js" integrity="sha256-xNzN2a4ltkB44Mc/Jz3pT4iU1cmeR0FkXs4pru/JxaQ=" crossorigin="anonymous"></script>
    ...
    <title>Tambah Customer | DB-Inventory Control</title>
                      ...
                      <form action="" method ="post" enctype="multipart/form-data" class="row g-3">
                        <div class="row">
                            ...
                            <div class="col mb-2">
                                ...
                                <input class="form-control" placeholder="e.g : +6281000000" type="text" name="notelp" id="notelp" required autocomplete ="off">  
                            </div>
                        </div>
                        <div class="mb-2">
                          <label for="alamat">Alamat</label>
                          <textarea class="form-control" name="alamat" id="alamat" style="height: 7rem"></textarea>
                        </div>
