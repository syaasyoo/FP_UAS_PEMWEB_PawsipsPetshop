...
$id = $_GET["id"];
$ganti  = query("SELECT * FROM reservasi WHERE id = $id")[0];
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.0/jquery.min.js" integrity="sha256-xNzN2a4ltkB44Mc/Jz3pT4iU1cmeR0FkXs4pru/JxaQ=" crossorigin="anonymous"></script>
    ...
    <title>Mengubah Reservasi | Admin Control</title>
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseCharts2" class="collapse" aria-labelledby="headingCharts"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Menu :</h6>
                        <a class="collapse-item" href="reservasi.php">Reservasi Control</a>
                        <a class="collapse-item" href="../adopsi/adopsi.php">Adopsi Control</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Begin Page Content -->
                ...
                <div class="d-flex justify-content-start pb-3">
                  <a href="reservasi.php"><button type="button" class="btn btn-light"><i class="bi bi-back"></i> Kembali</button></a>
                </div>
                <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Mengubah Reservasi</h1>
                    </div>
                <!-- Content Row -->
                    <!-- Formulir -->
                    ...
                    <input type="hidden" name="id" value="<?= $ganti["id"]?>">
                        <div class="row">
                          <div class="col mb-3">
                            ...
                            <select class="form-select" name="reservasi" id="reservasi" value="<?= $ganti["reservasi"]?>" required>
                          ...
                          <div class="col">
                            ...
                            <div class="mb-2">
                              <label for="waktu" class="form-label">Waktu</label>
                                     <input type="datetime-local" name="waktu" id="waktu" value="<?= $ganti["waktu"]?>" class="form-control"> 
                        </div>
                                             <div class="mb-2">
                              <label for="alamat" class="form-label">Alamat</label>
                              <input class="form-control" type="text" name="alamat" id="alamat" value="<?= $ganti["alamat"]?>" required autocomplete ="off">  
                            </div>    
                          </div>
                          <div class="col">
                                                     
                            <label for="reservasi" class="form-label">Status</label>
                            <select class="form-select" name="status" id="status" value="<?= $ganti["status"]?>" required>
  	...
  	<option value="Done">Done</option>
    	<option value="Cancel">Cancel</option>
                            ...
                            <div class="mb-2">
                              ...
                              <textarea class="form-control" name="pesan" id="pesan" style="height: 117px"><?= $ganti["pesan"]?></textarea>
                            </div>
                          </div>
                        ...
                        <div class="d-flex justify-content-center mb-3">
                          <button type="submit" name="submit" class="btn btn-warning">Selesai</button>
                        </div>
                      </form>
                    <!-- Akhir Formulir -->
                <!-- /.container-fluid -->
