...
// Query
    ...
    //tombol cari
    if ( isset($_POST["cari"])){
        $reservasi = carireservasi($_POST["keyword"]);
    }
?>
                ...
                <!-- Content Row -->
                    ...
                    <!-- Pencarian -->
                        ...
                        <div class="col-md-auto ps-3">
                            <a href="form.php"><button type="button" class="btn btn-warning me-4">Tambah  <i class="bi bi-plus-lg"></i></button></a>
                                ...
                                <div class="d-flex justify-content-center p-2 pb-2 overflow-y-scroll" style="max-height: 20rem;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            ...
                                            <a href="form.php?id=<?= $row["id"];?>"><button type="button" class="btn btn-secondary btn-sm p-1"><i class="bi bi-clipboard2-plus p-1"></i></button></a>
                                        </td>
                                    </tr>
                                    <?php endforeach ?>
                                    </table>
