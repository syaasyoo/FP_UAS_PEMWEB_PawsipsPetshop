...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.0/jquery.min.js" integrity="sha256-xNzN2a4ltkB44Mc/Jz3pT4iU1cmeR0FkXs4pru/JxaQ=" crossorigin="anonymous"></script>
    ...
    <title>Tambah Reservasi | Admin Control</title>
            ...
            <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 pt-4 ps-2">LUNA'S VET WEBSITE</h1>
                    </div>
                    <!-- Topbar Navbar -->
                      ...
                      <form action="" method ="post" enctype="multipart/form-data" class="row g-3">
                        <div class="row">
                          <div class="col mb-3">
                            ...
                            <select class="form-select" name="reservasi" id="reservasi" required>
  	...
  	<option value="konsultasi">Konsultasi</option>
    	<option value="penitipan">Penitipan</option>
                          ...
                          <div class="col mb-3">
                            ...
                            <input class="form-control" type="text" name="notelp" id="notelp" required autocomplete ="off">  
                          </div>
                        </div>
                        <div class="row">
                          <div class="col">
